// <copyright file="BaseCommand{T}.cs" company="3Dconnexion">
// -------------------------------------------------------------------------------------
...
// File History
//
// $Id: BaseCommand{T}.cs 15499 2018-11-06 07:31:28Z mbonk $
//
// </history>
...
namespace TDx.TestNL
{
    ...
    /// <summary>
    /// Encapsulates a <see cref="Action{T}"/> that has a single parameter and does not return a value.
    /// </summary>
    /// <typeparam name="T">The parameter of the method that the delegate encapsulates.</typeparam>
    public class BaseCommand<T> : ICommand
    {
        ...
        /// </summary>
        /// <param name="execute"><see cref="Action{T}"/> that is executed by the command.</param>
        ...
        public BaseCommand(Action<T> execute, Func<bool> canExecute)
        {
