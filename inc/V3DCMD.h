...
static char v3DCMDCvsId[]="(C) 2013-2024 3Dconnexion: $Id: V3DCMD.h 20674 2024-01-08 10:48:51Z jwick $";
...
typedef enum
{
   ...
   V3DCMD_MENU_15		= 164,
   V3DCMD_MENU_16       = 165,
   V3DCMD_NAVMODE_OBJECT = 166,
   V3DCMD_NAVMODE_FLY    = 167,
   V3DCMD_NAVMODE_TARGETCAMERA = 168,
   V3DCMD_NAVMODE_HELICOPTER   = 169,
   V3DCMD_NAVMODE_WALK         = 170,
   V3DCMD_NAVMODE_DRONE        = 171,
   V3DCMD_TOGGLE_LOCKHORIZON   = 172,
   V3DCMD_TOGGLE_MOVEOBJECT    = 173,
   V3DCMD_TOGGLE_PAUSEMOTION   = 174,
