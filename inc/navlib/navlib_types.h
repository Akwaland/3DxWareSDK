...
// File History
//
// $Id: navlib_types.h 21343 2025-01-23 07:42:33Z mbonk $
//
...
public:
  ...
  /// Random access iterator for the matrix.
  /// </summary>
  struct const_iterator : public std::allocator_traits<std::allocator<double>> {
    using base_type = std::allocator_traits<std::allocator<double>>;
    using reference = const base_type::value_type &;
    using pointer = const base_type::value_type *;
    using difference_type = base_type::difference_type;
    using iterator_category = std::random_access_iterator_tag;

    explicit const_iterator(struct matrix const *m, size_type index = 0)
        : m_container(m), m_index(index) {
    }
  ...
  protected:
    const struct matrix *m_container;
    size_type m_index;
  };
  ...
  /// <summary>
  /// Returns an <see cref="const_iterator"/> to the beginning.
  /// </summary>
  /// <returns>An <see cref="const_iterator"/> to the first element of the matrix.</returns>
  ...
  /// <summary>
  /// Returns an <see cref="const_iterator"/> to the end.
  /// </summary>
  /// <returns>An <see cref="const_iterator"/> to the element following the last element of the
  /// matrix.</returns>
